...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Boost 1.41.0 COMPONENTS program_options date_time serialization unit_test_framework regex system thread)
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    pkg_check_modules(Boost Boost>=1.41.0)
  endif()
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    message(FATAL_ERROR "Could not find Boost COMPONENTS program_options date_time serialization unit_test_framework regex system thread")
  endif()
else()
  find_package(Boost 1.41.0  REQUIRED program_options date_time serialization unit_test_framework regex system thread)
endif()
...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Qt5 5.3 COMPONENTS Core Gui Network OpenGL Xml XmlPatterns Svg WebKit Concurrent)
  if((NOT Qt5_FOUND) AND (NOT QT5_FOUND))
    pkg_check_modules(Qt5 Qt5>=5.3)
  endif()
  if((NOT Qt5_FOUND) AND (NOT QT5_FOUND))
    message(FATAL_ERROR "Could not find Qt4 COMPONENTS QtCore QtGui QtNetwork QtOpenGL QtXml QtXmlPatterns QtSvg QtWebKit")
  endif()
else()
  find_package(Qt5 5.3 REQUIRED Core Gui Network OpenGL Xml XmlPatterns Svg WebKit Concurrent)
endif()
...
set(DISPLAYCLUSTER_BUILD_DEBS autoconf;automake;cmake;doxygen;freeglut3-dev;git;git-review;libavcodec-dev;libavformat-dev;libavutil-dev;libboost-date-time-dev;libboost-program-options-dev;libboost-regex-dev;libboost-serialization-dev;libboost-system-dev;libboost-test-dev;libboost-thread-dev;libfcgi-dev;libjpeg-turbo8-dev;libopenmpi-dev;libpoppler-dev;libswscale-dev;libturbojpeg;libxmu-dev;openmpi-bin;pkg-config;subversion)
